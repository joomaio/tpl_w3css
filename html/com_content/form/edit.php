...
<div class="edit item-page<?php echo $this->pageclass_sfx; ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_content&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
		<div class="w3-card-4">
			<div class="submit-tab w3-bar w3-light-grey">
				<a class="w3-bar-item w3-button tablink active" onclick="openTabSubmit(event,'editor')">Editor</a>
				<a class="w3-bar-item w3-button tablink" onclick="openTabSubmit(event,'publishing')">Publishing</a>
				<a class="w3-bar-item w3-button tablink" onclick="openTabSubmit(event,'language')">Language</a>
				<a class="w3-bar-item w3-button tablink" onclick="openTabSubmit(event,'metadata')">Metadata</a>
			</div>
		...
		<div class="btn-toolbar">
			<div class="btn-group-edit w3-center">
				<button type="button" class="w3-button w3-green" onclick="Joomla.submitbutton('article.save')">
					<span class="icon-ok"></span><?php echo JText::_('JSAVE') ?>
				</button>
				<button type="button" class="w3-button w3-red" onclick="Joomla.submitbutton('article.cancel')">
