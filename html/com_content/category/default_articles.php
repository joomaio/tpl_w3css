...
<?php if ($this->params->get('filter_field') !== 'hide' || $this->params->get('show_pagination_limit')) : ?>
	<div class="btn-toolbar clearfix">
		<div class="filters-form w3-margin">
...
<?php else : ?>
	<div class="w3-card-4 w3-margin">
		<div class="table-header w3-padding w3-light-grey">
			<span class="table-title">List Table</span>
		...
		<div class="w3-padding">
			<table class="w3-white w3-table w3-striped w3-padding<?php echo $tableClass; ?>">
...
<?php if (!empty($this->items)) : ?>
	<?php if (($this->params->def('show_pagination', 2) == 1  || ($this->params->get('show_pagination') == 2)) && ($this->pagination->pagesTotal > 1)) : ?>
		<div class="pagination w3-row w3-margin">
