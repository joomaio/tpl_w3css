...
<?php if ($params->get('greeting', 1)) : ?>
	<div class="login-greeting w3-padding">
...
<?php endif; ?>
	<div class="logout-button w3-padding w3-white">
		<input type="submit" name="Submit" class="w3-button w3-red" value="<?php echo JText::_('JLOGOUT'); ?>" />
