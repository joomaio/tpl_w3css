...
<form id="finder-search" action="<?php echo JRoute::_($this->query->toUri()); ?>" method="get" class="form-inline">
	...
	<?php endif; ?>
	<div class="word w3-card-2">
		<input type="text" name="q" id="q" size="30" value="<?php echo $this->escape($this->query->input); ?>" class="w3-input" />
		<?php if ($this->escape($this->query->input) != '' || $this->params->get('allow_empty_query')) : ?>
			<button name="Search" type="submit" class="w3-button w3-green">
	...
	<div class="w3-card-2">
		<div class="w3-padding w3-light-grey" onclick="addCategories('advancedSearch')">
			<span class="category-title"><?php echo JText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?></span>
		</div>
		<div id="advancedSearch" class="w3-padding w3-hide">
