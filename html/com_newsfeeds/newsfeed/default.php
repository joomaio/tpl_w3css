...
<?php else : ?>
	...
	<div class="w3-padding newsfeed<?php echo $this->pageclass_sfx; ?><?php echo $direction; ?>">
		<?php if ($this->params->get('display_num')) : ?>
			<h1 class="<?php echo $direction; ?>">
				<?php echo $this->escape($this->params->get('page_heading')); ?>
			</h1>
		<?php endif; ?>
		<h2 class="nf-title <?php echo $direction; ?>">
			<a class="category-title" href="<?php echo $this->item->link; ?>" target="_blank">
		...
		<?php if (!empty($this->rssDoc[0])) : ?>
				...
				<?php for ($i = 0; $i < $this->item->numarticles; $i++) : ?>
					...
					<div class="w3-card-2 w3-padding nf-item">
						<?php if (!empty($uri)) : ?>
							<h3 class="feed-link">
