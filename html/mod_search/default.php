...
?>
<div class="search-top <?php echo $moduleclass_sfx; ?>">
	<form action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-inline" role="search">
		<?php
			...
			if ($button) :
				$btn_output = ' <button class="w3-button w3-green w3-text-white" onclick="this.form.searchword.focus();">' . $button_text . '</button>';
